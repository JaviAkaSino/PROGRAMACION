...
public class ParteB {
    ...
    public static void main(String[] args) {
        ...
        //Variables int, String y boolean; y Scanner y Random
        //La variable dedos2logico no es necesaria, porque limitaremos el Random
        Random numeroAleatorio = new Random();
        Scanner teclado = new Scanner(System.in);
        int dedos1, dedos2, totaldedos;
        String rol1, nombre1, nombre2;
        boolean rol1pares, rol1nones, pares, dedos1logico;
